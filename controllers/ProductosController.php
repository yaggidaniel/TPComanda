...
class ProductoController implements IApiUsable
{
    public function TraerUno($request, $response, $args)
    {
        ...
        $producto = Producto::TraerUnProductoPorIdONombre($idProducto, $nombreProducto);
    ...
    public function CargarUno($request, $response, $args)
{
    ...
    $productoExistente = Producto::TraerUnProductoPorIdONombre(null, $data['nombreProducto']);
